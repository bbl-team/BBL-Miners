...
public class TreeAbsorberRecipe implements Recipe<SimpleContainer> {
    ...
    public TreeAbsorberRecipe(ResourceLocation id, ItemStack output, NonNullList<Ingredient> recipeItems) {
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<TreeAbsorberRecipe> {
        ...
        public TreeAbsorberRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new TreeAbsorberRecipe(id, output, inputs);
        }
