...
public class CrusherScreen extends AbstractContainerScreen<CrusherMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Miners.MOD_ID,"textures/gui/crusher_gui.png");

    private EnergyDisplayTooltipArea energyInfoArea;
    private CrusherDisplayTooltipArea generatorInfoArea;
    ...
    private void assignGeneratorInfoArea() {
        generatorInfoArea = new CrusherDisplayTooltipArea(((width - imageWidth) / 2) + 156,
