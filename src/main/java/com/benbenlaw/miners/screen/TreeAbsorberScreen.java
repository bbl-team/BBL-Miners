...
public class TreeAbsorberScreen extends AbstractContainerScreen<TreeAbsorberMenu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Miners.MOD_ID,"textures/gui/tree_absorber_gui.png");

    private EnergyDisplayTooltipArea energyInfoArea;
    private TreeAbsorberDisplayTooltipArea generatorInfoArea;


    public TreeAbsorberScreen(TreeAbsorberMenu menu, Inventory inventory, Component component) {
    ...
    private void assignGeneratorInfoArea() {
        generatorInfoArea = new TreeAbsorberDisplayTooltipArea(((width - imageWidth) / 2) + 156,
